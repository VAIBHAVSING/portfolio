                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex flex-wrap items-center gap-x-3 gap-y-1 mb-1">
                      ...
                      <span className="text-[10px] rounded-md bg-primary/10 text-primary px-2 py-0.5 tracking-wide font-medium border border-primary/15 ">
                        {item.company}
                      </span>
                    </div>
                    ...
                    <div className="mt-3 flex flex-wrap gap-1.5">
                      {item.tech.map((t) => (
                        <span
                          key={t}
                          className="text-[10px] tracking-wide rounded-md px-2 py-0.5 bg-muted text-foreground/70 font-medium"
                        >
                          {t}
                        </span>
                      ))}
