...
export const metadata: Metadata = {
  ...
  description:
    "Portfolio of Vaibhav Patil, an open source contributor and software engineer specializing in full-stack development, machine learning, and innovative web applications.",
  keywords: [
    "Vaibhav Singh",
    "vaibhav",
    "patil",
