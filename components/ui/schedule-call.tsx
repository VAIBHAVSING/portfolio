    ...
    <section id="contact" className="py-32 relative">
      ...
      <div className="max-w-5xl mx-auto px-6">
        <div className="text-center mb-14">
          <h2 className="text-4xl font-bold tracking-tight bg-gradient-to-r from-primary via-primary/60 to-primary/30 bg-clip-text text-transparent">Let&apos;s Talk</h2>
          <p className="mt-4 text-muted-foreground text-sm md:text-base max-w-2xl mx-auto">Have a project, collaboration idea or mentoring request? Book a quick 15 minute call directly in my calendar.</p>
        </div>
